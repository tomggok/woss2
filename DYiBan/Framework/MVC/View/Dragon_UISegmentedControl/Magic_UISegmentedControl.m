...
#import "Magic_UISegmentedControl.h"
#import "UIView+MagicViewSignal.h"

#define SVSegmentedControlBG [[UIImage imageNamed:@"Magic_UISegmentedControl.bundle/inner-shadow"] stretchableImageWithLeftCapWidth:4 topCapHeight:5]


@interface MagicUISegmentedThumb ()

@property (nonatomic, assign) MagicUISegmentedControl *segmentedControl;
...
@interface MagicUISegmentedControl()
...
#pragma mark -
@implementation MagicUISegmentedControl
...
- (MagicUISegmentedThumb *)thumb {
    
    if(thumb == nil)
        thumb = [[MagicUISegmentedThumb alloc] initWithFrame:CGRectZero];
...
- (void)segmentedControlChangedValue:(MagicUISegmentedControl*)segmentedControl {
    ...
    [self sendViewSignal:[MagicUISegmentedControl SEGMENTCHANGED] withObject:segmentedControl from:self];
