...
#import "Magic_UIZoomView.h"

@implementation MagicUIZoomInnerView
...
@implementation MagicUIZoomView
DEF_SIGNAL(ZOOMING)
DEF_SIGNAL(ZOOMED)
...
- (void)initSelf:(CGRect)frame
{
    ...
    [_innerView release];
	_innerView = [[MagicUIZoomInnerView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
...
- (void)handleViewSignal_MagicUIImageView:(MagicViewSignal *)signal
{
...
{
    [self sendViewSignal:[MagicUIZoomView ZOOMING]];
}

- (void)scrollViewDidZoom:(UIScrollView *)scrollView
{
    [self sendViewSignal:[MagicUIZoomView ZOOMED]];
}
...
- (void)zoomInnerViewSingleTapped:(MagicUIZoomInnerView *)view location:(CGPoint)location
{
    ...
    [self sendViewSignal:[MagicUIZoomView SINGLE_TAPPED] withObject:dict];
}
...
- (void)zoomInnerViewDoubleTapped:(MagicUIZoomInnerView *)view location:(CGPoint)location
{
    ...
    [self sendViewSignal:[MagicUIZoomView DOUBLE_TAPPED]];
