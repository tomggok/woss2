...
@interface MagicUIScrollListView()
{
    MagicUIScrollView *_scrollview;
    
    MagicUIZoomView *firstView;
    MagicUIZoomView *seconView;
    MagicUIZoomView *thirdView;
    
    MagicUIImageView *firstImgView;
    MagicUIImageView *seconImgView;
    MagicUIImageView *thirdImgView;
...
@implementation MagicUIScrollListView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        _scrollview = [[MagicUIScrollView alloc] initWithFrame:self.bounds];
        ...
        seconView = [[MagicUIZoomView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame))];
        seconImgView = [[MagicUIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(seconView.frame), CGRectGetHeight(seconView.frame))];
        
        firstView = [[MagicUIZoomView alloc] initWithFrame:CGRectMake(seconView.frame.origin.x - CGRectGetWidth(seconView.frame), 0, CGRectGetWidth(seconView.frame), CGRectGetHeight(seconView.frame))];
        firstImgView = [[MagicUIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(seconView.frame), CGRectGetHeight(seconView.frame))];
        
        thirdView = [[MagicUIZoomView alloc] initWithFrame:CGRectMake(seconView.frame.origin.x + CGRectGetWidth(seconView.frame), 0, CGRectGetWidth(seconView.frame), CGRectGetHeight(seconView.frame))];
        thirdImgView = [[MagicUIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(seconView.frame), CGRectGetHeight(seconView.frame))];
...
- (void)setImgIndex:(NSInteger)index
{
    ...
    [self sendViewSignal:[MagicUIScrollListView SCROLLVIEWNUM] withObject:dict];
...
{
    if ([signal is:[MagicUIScrollView SCROLLVIEWDIDSCROLL]])
    {
