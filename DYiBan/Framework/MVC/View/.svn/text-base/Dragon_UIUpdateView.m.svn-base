...
@interface DragonUIUpdateView ()
@property (nonatomic, assign)BOOL broken;
@property (nonatomic, retain)DragonUIScrollView *scrollView;

@end

@implementation DragonUIUpdateView
{
...
- (id)initWithHeight:(CGFloat)height
{
    ...
    if (self)
    {
        ...
        _refleshView = [[DragonUIImageView alloc] initWithImage:[UIImage imageNamed:@"sr_refresh"]];
...
- (void)didMoveToSuperview
{
    ...
    {
//        DragonUITableView *tableView = ;
        _scrollView = (DragonUIScrollView *)[self superview];
...
#pragma mark -
#pragma mark action
- (void)pullApart:(DragonUIUpdateView *)refreshView
{
    self.broken = YES;
    _unmissSlime = YES;
    self.loading = YES;
