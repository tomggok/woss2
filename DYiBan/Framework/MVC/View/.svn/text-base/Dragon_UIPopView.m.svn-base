...
#import "Dragon_UIPopView.h"

@interface DragonUIPopView ()
{
    //阴影背景
    UIView *_shadowView;
...
@implementation DragonUIPopView
...
- (void)releaseSelf
{
    ...
    [self sendViewSignal:[DragonUIPopView POPHIDDEN]];
}
//隐藏并释放
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    {
        [self sendViewSignal:[DragonUIPopView POPTOUCHEDOTHER]];
    }
