...
typedef enum {
    DTableViewNomal =0,
    DTableViewSlime =1
}DragonUITableViewType;

typedef enum
{
    DragonReHeightNomal = 0,
    DragonReHeightMiddle = 1
    
}DragonSlimeRefreshHeightType;
...
@property (nonatomic, assign)DragonUITableViewType tableViewType;
