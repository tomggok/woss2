...
@interface MagicViewSignal : NSObject
{
    BOOL        _dead;     //是否废弃
    BOOL        _reach;    //是否触达顶级
...
@property (nonatomic, /*retain*/ assign/*避免例如MagicUITableView.m的cellForRowAtIndexPath函数的dict变量在RELEASEDICTARRAYOBJ()宏后未释放干净*/)NSObject       *object;        //附带参数
