...
@interface MagicUISearchBar : UISearchBar <UISearchBarDelegate>
{
    BOOL _isHideLeftView/*是否隐藏左边的视图*/;
    MagicUIButton *_bt_Shade/*用于点开搜索后遮罩键盘外的区域*/,*_bt_cancel;
}
...
@property (nonatomic,retain) MagicUIButton *bt_Shade/*用于点开搜索后遮罩键盘外的区域*/;
