...
@implementation MagicUIButtonState
...
- (MagicUIButtonState *)stateNormal
{
    if (!_stateNormal) {
        _stateNormal = [[MagicUIButtonState alloc] init];
...
- (MagicUIButtonState *)stateHighlighted
{
    if (!_stateHighlighted) {
        _stateHighlighted = [[MagicUIButtonState alloc] init];
...
- (MagicUIButtonState *)stateDisabled
{
    if (!_stateDisabled) {
        _stateDisabled = [[MagicUIButtonState alloc] init];
...
- (MagicUIButtonState *)stateSelected
{
    if (!_stateSelected) {
        _stateSelected = [[MagicUIButtonState alloc] init];
...
- (void)didTouchDown
{
    if (![self checkEvent:UIControlEventTouchDown]) {
        [self sendViewSignal:[MagicUIButton TOUCH_DOWN]];
    }
}
...
- (void)didTouchDownRepeat
{
    if (![self checkEvent:UIControlEventTouchDownRepeat]) {
        [self sendViewSignal:[MagicUIButton TOUCH_DOWN_REPEAT]];
    }
}
...
- (void)didTouchUpInside
{
    if (![self checkEvent:UIControlEventTouchUpInside]) {
        [self sendViewSignal:[MagicUIButton TOUCH_UP_INSIDE]];
    }
}
...
- (void)didTouchOutSide
{
    if (![self checkEvent:UIControlEventTouchUpOutside]) {
        [self sendViewSignal:[MagicUIButton TOUCH_UP_OUTSIDE]];
    }
}
...
- (void)didTouchCancel
{
    if (![self checkEvent:UIControlEventTouchCancel]) {
        [self sendViewSignal:[MagicUIButton TOUCH_UP_CANCEL]];
    }
}
